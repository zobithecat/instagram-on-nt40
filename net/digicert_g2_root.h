/* Generated by tools/der_to_c.py from vm/tls_mock/digicert_root_g2.der (914 bytes). */
static const unsigned char k_digicert_g2_root_der[] = {
...
static const unsigned int k_digicert_g2_root_der_len = 914;
